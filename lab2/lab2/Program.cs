...
namespace lab2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //uint b;				  0 .. 4,294,967,295
            //byte c;				  0 .. 255
            //sbyte d;				  -128 .. 127
            //short e;				  -32,768 .. 32,767
            //ushort f;				  0 .. 65,535
            //float g;				  -3,402823e38 .. -3,402823e38 ..
            //double h;				  -1,79769313486232e308 .. 1,79769313486232e308
            //decimal i;			  -79228162514264337593543950335 .. 79228162514264337593543950335
            //long j;				  -9,223,372,036,854,775,808 .. 9,223,372,036,854,775,807
            //ulong k;				  0 .. 18,446,744,073,709,551,615
            //char l;				  Символ Юникода.
            //string m;				  Строка символов Юникода.
            ...
            if (NullBoolVar.HasValue)
            {
                Console.WriteLine(NullBoolVar.Value);
            }
