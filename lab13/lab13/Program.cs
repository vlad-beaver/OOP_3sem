...
namespace lab13
{
    class ZDALog
    {
        ...
        public void WriteFile(string action, string filePath = @"C:\Users\User\Downloads\OOP\lab13\ZDAlogfile.txt", string fileName = "ZDAlogfile.txt")
        {
        ...
        public void WriteFile(List<string> action, string filePath = @"C:\Users\User\Downloads\OOP\lab13\ZDAlogfile.txt", string fileName = "ZDAlogfile.txt")
        {
            StreamWriter sw = new StreamWriter(filePath, true, Encoding.Default);
            sw.WriteLine("Имя файла: " + fileName);
            sw.WriteLine("Путь к файлу " + filePath);
    ...
    class ZDAFileInfo
    {
        ...
        public string FullPath(string path = @"C:\Users\User\Downloads\OOP\lab13\ZDAlogfile.txt")
        {
            FileInfo f = new FileInfo(path);
            action = "Полный путь к файлу: " + f.DirectoryName;
            return action;
        }
        public string Info(string path = @"C:\Users\User\Downloads\OOP\lab13\ZDAlogfile.txt")
        {
            FileInfo f = new FileInfo(path);
        ...
        public string Dates(string path = @"C:\Users\User\Downloads\OOP\lab13\ZDAlogfile.txt")
        {
            FileInfo f = new FileInfo(path);
    ...
    {
        private string action;
        public string AmountOfFiles(string path = @"C:\Users\User\Downloads\OOP\lab13\prog")
        {
            int amount = 0;
        ...
        public string CreateDate(string path = @"C:\Users\User\Downloads\OOP\lab13\prog")
        {
            DirectoryInfo directory = new DirectoryInfo(path);
            action = "Дата создания: " + directory.CreationTime;
            return action;
        }
        public string AmountDirs(string path = @"C:\Users\User\Downloads\OOP\lab13\prog")
        {
            int amount = 0;
            DirectoryInfo directory = new DirectoryInfo(path);
        ...
        public string Parent(string path = @"C:\Users\User\Downloads\OOP\lab13\prog")
        {
            DirectoryInfo directory = new DirectoryInfo(path);
    ...
    class ZDAFileManager
    {
        ...
        public List<string> FilesAndDirsList(string diskName = @"C:\Users\User\Downloads\OOP\lab13")
        {
        ...
        public string CreateDir(string path = @"C:\Users\User\Downloads\OOP\lab13\ZDAInspect")
        {
        ...
        public string CreateFile(string path = @"C:\Users\User\Downloads\OOP\lab13\ZDAInspect\zdadirinfo.txt")
        {
        ...
        public string CopyInfo(string path = @"C:\Users\User\Downloads\OOP\lab13\ZDAInspect\zdadirinfo1.txt")
        {
            StreamWriter sw = new StreamWriter(path, false, Encoding.Default);
            StreamReader sr = new StreamReader(@"C:\Users\User\Downloads\OOP\lab13\ZDAInspect\zdadirinfo.txt");
            sw.WriteLine(sr.ReadLine());
            sr.Close();
            File.Delete(@"C:\Users\User\Downloads\OOP\lab13\ZDAInspect\zdadirinfo.txt");
            return "Произошло копирование в новый файл" + path + "и удаление исходного файла";
        }
        public string CreateDirTwo(string path = @"C:\Users\User\Downloads\OOP\lab13\prog\lab13\ZDAFiles")
        {
        ...
        public string CopyFiles(string path = @"C:\Users\User\Downloads\OOP\lab13\prog")
        {
            ...
            {
                if (f.Extension == "txt")
                    f.CopyTo(@"C:\Users\User\Downloads\OOP\lab13\ZDAFiles");
            }
            return "Произошло копирование файлов";
        }
        public string MoveDir(string path = @"C:\Users\User\Downloads\OOP\lab13\ZDAFiles")
        {
            DirectoryInfo dir = new DirectoryInfo(path);
            dir.MoveTo(@"C:\Users\User\Downloads\OOP\lab13\ZDAInspect\NewDir");
            return "Произошло перемещение папки";
        }
        public string Zip()
        {
            string sourceFolder = @"C:\Users\User\Downloads\OOP\lab13\ZDAInspect\NewDir\ZDAFiles";
            string zipFile = @"C:\Users\User\Downloads\OOP\lab13\ZDAFiles.zip";
            string targetFolder = @"C:\Users\User\Downloads\OOP\lab13\ZDAFiles\New";
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            finally
            {
                ...
                StreamReader file = new StreamReader(@"C:\Users\User\Downloads\OOP\lab13\ZDAlogfile.txt");
